...
/// <summary>
/// Validator cho SupplierSearchRequest
/// Kế thừa validation từ BasePaginationValidator và thêm validation cho các filters riêng
/// </summary>
public class SupplierSearchRequestValidator : BasePaginationValidator<SupplierSearchRequest>
{
    public SupplierSearchRequestValidator()
    {
        // Base pagination validation rules được kế thừa từ BasePaginationValidator

        // Validation cho SortBy - chỉ cho phép các property hợp lệ của SupplierEntity
        RuleFor(x => x.SortBy)
