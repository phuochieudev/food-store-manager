...
import { customerAdminDefinition } from './definition/customers.definition';
import type { ModuleRoutes } from '../../type/types';

// Export một object tạm thời để phá vỡ sự phụ thuộc vòng tròn
export const customersRoutes: object = {};
...
const generatedModule: ModuleRoutes<any> = {
  ...
  basePath: '/customers',
  routes: generateManagementRouteConfigs(customerAdminDefinition),
};
