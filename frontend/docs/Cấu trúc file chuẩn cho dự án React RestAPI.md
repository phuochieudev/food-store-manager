...
│   └── routes/           // Chứa các file định nghĩa route cho cơ chế file-based routing của TanStack Router
...
└── styles/               // Các file CSS/SCSS dùng chung
```
...
- `common.ts`: Các kiểu dữ liệu chung (ví dụ: `ApiResponse`, `PagedList`).
